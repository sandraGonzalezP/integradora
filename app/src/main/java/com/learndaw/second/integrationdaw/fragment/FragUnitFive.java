...
import com.learndaw.second.integrationdaw.quiz.QuizFiveActivity;


/**
 * A simple {@link Fragment} subclass.
 * Activities that contain this fragment must implement the
 * {@link FragUnitFive.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FragUnitFive#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragUnitFive extends Fragment {

    private Button btEvaluationV;
     ...
     * @return A new instance of fragment FragUnitFive.
     */
    // TODO: Rename and change types and number of parameters
    public static FragUnitFive newInstance(String param1, String param2) {
        FragUnitFive fragment = new FragUnitFive();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista =  inflater.inflate(R.layout.fragment_frag_unit_five, container, false);

        btEvaluationV =(Button)vista.findViewById(R.id.btnQuizV);
        isPlaying=false;
        ...
        btEvaluationV.setOnClickListener(new View.OnClickListener(){

            @Override
            public void onClick(View v) {
                Intent quiz = new Intent(getActivity(), QuizFiveActivity.class);
                startActivity(quiz);
