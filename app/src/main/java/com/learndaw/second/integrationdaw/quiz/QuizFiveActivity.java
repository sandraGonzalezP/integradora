...
public class QuizFiveActivity extends AppCompatActivity {
    ...
    private QuestionsVLibrary nQuestionLibrary5 = new QuestionsVLibrary();
...
// This Line is opcional
                    Toast.makeText(QuizFiveActivity.this, "Correcto", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(QuizFiveActivity.this, "Error", Toast.LENGTH_SHORT).show();
                    updateQuestion();
                }
            }
        });
...
// Star of Button Listener for Button Quit
        nButtonQuit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentLevel = new Intent(QuizFiveActivity.this, LevelsActivity.class);
    ...
    private void updateQuestion() {
        if (nQuestionNumber == 10) {
            ...
            nQuestionView.setText(nQuestionLibrary5.getQuestion(nQuestionNumber));
            nButtonChoice1.setText(nQuestionLibrary5.getChoices1(nQuestionNumber));
            nButtonChoice2.setText(nQuestionLibrary5.getChoices2(nQuestionNumber));
            nButtonChoice3.setText(nQuestionLibrary5.getChoices3(nQuestionNumber));
            nAnswer = nQuestionLibrary5.getCorrectAnswer(nQuestionNumber);
            nQuestionNumber++;
        }
    }
    ...
    private void finishQuiz() {
        ...
        childUpdates.put("unit_five", nScore);
        myRef.updateChildren(childUpdates);
        if (nScore >= 8) {
            Intent intentGif = new Intent(QuizFiveActivity.this, GifActivity.class);
            startActivity(intentGif);
        } else {
            Intent intentLevels = new Intent(QuizFiveActivity.this, LevelsActivity.class);
