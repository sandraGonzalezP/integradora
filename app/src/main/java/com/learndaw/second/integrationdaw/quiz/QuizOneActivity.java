...
public class QuizOneActivity extends AppCompatActivity {
    ...
    private QuestionsILibrary nQuestionLibrary = new QuestionsILibrary();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nButtonChoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (nButtonChoice1.getText() == nAnswer) {
                    ...
                    Toast.makeText(QuizOneActivity.this, "Correcto", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(QuizOneActivity.this, "Error", Toast.LENGTH_SHORT).show();
                    updateQuestion();
                }
            }
        });
        ...
        nButtonQuit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentLevel = new Intent(QuizOneActivity.this, LevelsActivity.class);
    ...
    private void updateQuestion() {
        ...
        childUpdates.put("unit_one",nScore);
        myRef.updateChildren(childUpdates);
        if (nQuestionNumber == 10) {
            finishQuiz();
        } else {
            nQuestionView.setText(nQuestionLibrary.getQuestion(nQuestionNumber));
            nButtonChoice1.setText(nQuestionLibrary.getChoices1(nQuestionNumber));
            nButtonChoice2.setText(nQuestionLibrary.getChoices2(nQuestionNumber));
            nButtonChoice3.setText(nQuestionLibrary.getChoices3(nQuestionNumber));
    ...
    private void finishQuiz() {
        if (nScore >= 8) {
            Intent intentGif = new Intent(QuizOneActivity.this, GifActivity.class);
            startActivity(intentGif);
        } else {
            Intent intentLevels = new Intent(QuizOneActivity.this, LevelsActivity.class);
